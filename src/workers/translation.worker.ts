/**
 * Runs @xenova/transformers only in this worker (never on the main thread).
...
/** Hub model for LID (Transformers.js–compatible ONNX). Prompt asked for language-detection; this is the supported Xenova LID export. */
