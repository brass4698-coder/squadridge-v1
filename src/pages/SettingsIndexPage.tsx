  ...
  return (
    <ul className="m-0 grid list-none gap-4 p-0">
      <li>
        ...
        >
          <h2 className="font-heading text-lg font-medium text-ink">Profile &amp; keys</h2>
      ...
      <li>
        <Link
          ...
          className="sr-vault-card sr-vault-card--interactive block p-5 no-underline"
        >
          <h2 className="font-heading text-lg font-medium text-ink">Safety center</h2>
          <p className="mt-2 text-sm leading-relaxed text-ink-secondary">
      ...
      <li>
        <Link
          ...
          className="sr-vault-card sr-vault-card--interactive block p-5 no-underline"
        >
          <h2 className="font-heading text-lg font-medium text-ink">Notifications</h2>
          <p className="mt-2 text-sm leading-relaxed text-ink-secondary">
