...
function RequiredMark() {
  return (
    <span className="ml-1.5 align-middle font-sans text-[0.65rem] font-bold uppercase tracking-[0.14em] text-teal-light/90">
      Required
    </span>
  );
}
    ...
    <div className="relative mx-auto w-full max-w-[560px] px-gutter py-12">
      ...
      <div className="relative z-[1]">
        ...
        >
          ...
          <section className="sr-section-card space-y-6" aria-labelledby="pf-identity-heading">
            <div>
              <h2
            ...
            <div className="space-y-2">
              ...
              {tagsList.length > 0 ? (
                <ul className="m-0 flex list-none flex-wrap gap-1.5 p-0" aria-label="Parsed tags">
                  {tagsList.slice(0, MAX_TAGS).map((t) => (
                    <li
                      key={t}
                      className="inline-flex max-w-full truncate rounded-md border border-line-strong/60 bg-navy-dark px-2 py-0.5 font-mono text-[0.68rem] text-ink-secondary"
                    >
                      {t}
                    </li>
                  ))}
              ...
              <input
                ...
                className={`sr-input ${tagsTooMany ? 'border-amber/50' : ''}`}
          ...
          <section className="sr-section-card space-y-6" aria-labelledby="pf-routing-heading">
            <div>
              <h2
              ...
              <p className="mt-2 max-w-[52ch] font-sans text-[0.8rem] leading-relaxed text-ink-subtle">
                <strong className="font-semibold text-ink-secondary">Used for matching only</strong>
                <span className="text-ink-subtle"> — </span>
                <span className="text-ink-secondary">not shown to squads.</span>
              </p>
              <details className="group mt-3 rounded-lg border border-line/70 bg-navy-dark/60 px-3 py-2">
                ...
                <p className="mt-2 border-t border-line/60 pt-2 font-sans text-[0.78rem] leading-relaxed text-ink-subtle">
        ...
        {supabase ? (
          <section className="sr-section-card mt-10">
            ...
            <div className="mt-5 grid gap-6 sm:grid-cols-2">
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="sr-input inline-flex min-h-[40px] w-full items-center justify-center px-4 text-[0.88rem] font-sans transition hover:bg-navy-dark/80 disabled:opacity-60"
                >
                  {demoClaimBusy ? 'Generating…' : 'Generate transfer code'}
                </button>
                {demoClaimCode ? (
                  <p className="break-all rounded-[6px] border border-line bg-navy-dark px-3 py-2 font-mono text-[0.8rem] text-teal-light/95">
                    {demoClaimCode}
                  </p>
                ) : null}
                {demoClaimErr ? (
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="btn-primary w-full min-h-[40px] justify-center text-[0.88rem]"
                >
        ...
        <NextStepHint className="mt-8">
          <span className="font-medium text-ink-secondary">Next:</span> When you&apos;re ready to
          match, use Find squad from the menu. This profile helps route you into the right pool.
        </NextStepHint>

        <div
          className="pointer-events-none fixed inset-x-0 bottom-0 z-20 flex justify-center border-t border-line bg-navy-dark/92 px-gutter py-3 backdrop-blur-md sm:px-6"
        ...
        >
          <div className="pointer-events-auto flex w-full max-w-[560px] flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
            ...
            <button
              ...
              className="btn-primary min-h-[44px] w-full shrink-0 justify-center text-[0.95rem] sm:ml-auto sm:w-auto"
            >
