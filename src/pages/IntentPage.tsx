        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center">
          {demoPath ? (
            <>
              ...
              <Link
                to="/?demo=1"
                className="inline-flex min-h-[44px] items-center justify-center rounded-lg border border-line-strong px-6 py-3 font-sans text-[0.9rem] font-medium text-ink-secondary transition-colors hover:border-line-strong/80 hover:text-ink"
              >
      ...
      <div className="mt-12 flex flex-col gap-12">
        ...
        <div className="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center">
          <button
            ...
            className="intent-primary-cta inline-flex min-h-[52px] w-full shrink-0 items-center justify-center rounded-lg px-8 py-3 font-heading text-[0.95rem] font-bold text-navy transition-[box-shadow,opacity] duration-150 ease-out hover:opacity-[0.97] disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
          >
        ...
        <button
          type="button"
          onClick={handleSkip}
          className="sr-ghost-link self-center text-[0.9rem] font-medium"
        >
        ...
        {error ? (
          <div
            className="flex flex-col gap-3 rounded-[10px] border border-amber/35 bg-amber/[0.07] px-4 py-3"
            role="alert"
          >
            <p className="font-sans text-[0.875rem] leading-relaxed text-amber-200">{error}</p>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
                className="btn-primary min-h-[40px] px-4 py-2 text-[0.85rem]"
              ...
              <button
                type="button"
                className="btn-secondary min-h-[40px] px-4 py-2 text-[0.85rem]"
