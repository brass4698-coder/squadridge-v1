...
export const INITIAL_DECKS: PitchDeck[] = [
  ...
  },
  {
    ...
    purpose:
      'Technical diligence: identity, verification posture, ciphertext storage, squad keys, moderator visibility, gaps vs roadmap.',
    status: 'internal',
    lastUpdatedISO: new Date().toISOString(),
    confidence: 'verified',
    slideCount: 10,
    ...
    sectionsOutline: [
      ...
      'Encryption scope (current)',
      'Operator visibility (explicit)',
      'Ledger / proposals flow',
      'Trust & safety posture',
      'Known limitations',
      'Roadmap (non-marketing tone)',
    ],
  },
  {
    id: 'facilitator-demo',
    name: 'Facilitator / Demo Walkthrough',
    audience: 'facilitators_demos',
    narrativeEmphasis:
      'Fewer total slides, maximum clarity per step — flow and prompts over business case; same design tokens and lockup as formal decks.',
    purpose:
      'Live walkthrough: routing, room dynamics, demo session, and how to explain verified-anonymous strategy rooms quickly.',
    status: 'draft',
    lastUpdatedISO: new Date().toISOString(),
    confidence: 'mixed',
    slideCount: 8,
    ...
    sectionsOutline: [
      'Opening frame',
      'Intent → match narrative',
      'Room norms',
      'Ledger & proposals snapshot',
      'Facilitator prompts',
      'Q&A guardrails',
    ],
  },
