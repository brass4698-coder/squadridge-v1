...
export const obSubtitle = "mt-2 mb-0 font-sans text-[9px] font-medium tracking-[0.1em] text-white/30";

/** Primary page title — same scale on every step (matches step 1 manifesto). */
export const obH1Hero =
  "font-display text-[1.85rem] font-bold leading-[1.12] tracking-[-0.02em] text-white sm:text-4xl md:text-5xl md:leading-[1.08] lg:text-[3.15rem]";
