              ...
              {publicNav.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ...
                    (isActive ? 'bg-surface-accent text-ink' : 'text-ink-secondary hover:text-ink')
                  }
                >
                  {item.label}
                </NavLink>
          ...
          <div className="grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,2fr)] md:gap-14">
            <div>
              ...
              <p className="max-w-sm text-sm leading-relaxed text-ink-secondary">
                Privacy-first facilitation infrastructure. Private session rooms. Approved outcomes
                only.
              </p>
            </div>
