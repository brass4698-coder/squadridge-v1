    ...
    >
      <div className="mx-auto flex max-w-6xl flex-wrap items-start gap-2">
        ...
        <p className="min-w-0 flex-1">
          <strong className="font-semibold text-[#fde68a]">ZK stub mode:</strong> verification is a
          fast hash-only demo, not a Semaphore zero-knowledge proof. Do not use for real users or
          partner demos. Set{' '}
          <code className="rounded bg-black/30 px-1 py-0.5 font-mono text-[0.8rem]">
            VITE_ZK_STUB=false
          </code>{' '}
          and deploy the{' '}
          <code className="rounded bg-black/30 px-1 py-0.5 font-mono text-[0.8rem]">
