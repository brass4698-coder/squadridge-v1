...
export function OfflineBanner() {
  ...
  return (
    ...
    >
      ...
      <span>
        Offline – waiting to reconnect. Messaging and sign-in resume when your connection does.
      </span>
      <button
        type="button"
        className="inline-flex min-h-[44px] min-w-0 items-center justify-center rounded-[6px] border border-[#6b5a2a] bg-[#3d3318] px-3 py-2 font-heading text-[0.8rem] font-semibold text-[#f5d78e] transition-opacity hover:opacity-90"
