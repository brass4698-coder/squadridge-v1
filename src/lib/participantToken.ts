      ...
      messages: [
        {
          ...
          body: 'Welcome. You are in a pseudonymous written room — codenames only, no attribution in any public record.',
          sent_at: new Date(Date.now() - 120_000).toISOString(),
        },
        {
          id: 'demo-msg-2',
          sender_label: 'Upstream Steward',
          sender_role: 'participant',
          body: 'We need a path forward on seasonal flow allocations without naming individual treaty signatories in any release.',
          sent_at: new Date(Date.now() - 90_000).toISOString(),
        },
        {
          id: 'demo-msg-3',
          sender_label: 'Downstream Coalition',
          sender_role: 'participant',
          body: 'Agreed on process. Request a structured options round before we draft language for the outcome memo.',
