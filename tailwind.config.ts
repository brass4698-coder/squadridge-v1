  ...
  theme: {
    extend: {
      colors: {
        ...
        /** Marketing homepage palette (Phase 10 redesign — raw brand hex,
            scoped to public marketing surfaces, not the app token system). */
        squadridge: {
          bg: '#09111F',
          deep: '#123B7A',
          teal: '#16C7B8',
      ...
      fontFamily: {
        sans: ['var(--sr-font-body)'],
        display: ['var(--sr-font-display)'],
        heading: ['var(--sr-font-heading)'],
        mono: ['var(--sr-font-mono)'],
        /** Public Sans — marketing homepage UI font (Phase 10 redesign). */
