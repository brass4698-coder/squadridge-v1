...
### Added
- `AGENTS.md` — AI agent context file describing stack, rules, and architecture
- `codeql.yml` — CodeQL static analysis scanning TypeScript/JavaScript on push, PR, and weekly schedule
...
### Changed
- Stale GitHub template workflows (`jekyll-docker.yml`, `webpack.yml`, `npm-publish-github-packages.yml`,
  `deno.yml`) replaced with disabled stubs + explanatory comments
